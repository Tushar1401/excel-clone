            ...
            $(".sheet-rename").click(function () {
                $(".container").append(`
                                        <div class="sheet-rename-modal">
                                            ...
                                            <input class="new-sheet-name" type="text" placeholder="Sheet Name">
            ...
            $(".sheet-delete").click(function () {
                $(".container").append(`
                                        <div class="sheet-delete-modal">
                                            <h4 class="modal-title">Confirmaton</h4>
                                            <p class="modal-permission">Are you sure you want to <br> delete this sheet?</p>
                                            <div class="action-buttons">
                                                <div class="submit-delete-button">
                                                    Delete
                                                </div>
                ...
                $(".submit-delete-button").click(function () {
                    ...
                    if (Object.keys(cellData).length > 1) {
                        ...
                        currentSheet.remove(); // removing from UI
                        delete cellData[currentSheetName] // deleting from cellData
                        ...
                        alert("Sorry, there is only one sheet! You cannot delete it");
                        $(".sheet-delete-modal").remove();
                    }
                });
...
$(".icon-paste").click(function () {
    ...
    for (let cell of selectedCells) {
        ...
        //  - 1; // because rowId,colId is starting from 1,1 and here we want to start from 0,0
